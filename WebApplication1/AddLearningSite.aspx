<%@ Page Title="Create Learning Site" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddLearningSite.aspx.cs" Inherits="JACSBcafg.CreateLearningSite" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <h2><%: Title %></h2>

    <fieldset>
        <legend><h3>Lets get some info</h3></legend>
