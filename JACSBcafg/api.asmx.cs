...
namespace JACSBcafg
{
    ...
    public class api : System.Web.Services.WebService
    {
        ...
        */
        ...
        [WebMethod]
        public void createLearningSite(string lsName, string lsOwnerName, string lsEmail, string lsPhoneNumber, string lsWebAddress)
        {
            addParam("@lsName", lsName);
            addParam("@lsOwnerName", lsOwnerName);
            addParam("@lsEmail", lsEmail);
            addParam("@lsPhoneNumber", lsPhoneNumber);
            addParam("@lsWebAddress", lsWebAddress);
